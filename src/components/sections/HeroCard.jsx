const stack = [
  ...
  { label: "PostgreSQL", rotate: "rotate-2" },
  { label: "Tailwind CSS", rotate: "" },
];

export default function HeroCard() {
  return (
    <div className="relative flex size-full flex-col justify-center gap-8 overflow-hidden rounded-xl border-t-2 border-b-2 border-l-4 border-r-[3px] border-[#d8c7ac] bg-white px-6 py-8 shadow-[4px_4px_0_0_#241f1b] sm:px-9">
